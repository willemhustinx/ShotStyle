...
function competition_cb()
{
	...
	<table class="form-table
		<tr valign="top">
			...
			<td><input name="regio" type="text" id="regio" class="regular-text" value="<?php if(isset($meta['regio'])){ echo $meta['regio'];} ?>" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="poule">Poule</label></th>
			<td><input name="poule" type="text" id="poule" class="regular-text" value="<?php if(isset($meta['poule'])){ echo $meta['poule'];} ?>" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="verenigingscode">Verenigings code</label></th>
			<td><input name="verenigingscode" type="text" id="teamid" class="regular-text" value="<?php if(isset($meta['verenigingscode'])){ echo $meta['verenigingscode'];} ?>" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="teamtype">Team type</label></th>
			<td><input name="teamtype" type="text" id="teamtype" class="regular-text" value="<?php if(isset($meta['teamtype'])){ echo $meta['teamtype'];} ?>" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="volgnummer">Volgnummer</label></th>
			<td><input name="volgnummer" type="text" id="volgnummer" class="regular-text" value="<?php if(isset($meta['volgnummer'])){ echo $meta['volgnummer'];} ?>" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="teamid">Team id</label></th>
			<td><input name="teamid" type="text" id="teamid" class="regular-text" value="<?php if(isset($meta['teamid'])){ echo $meta['teamid'];} ?>" /></td>
		</tr>
...
function team_get_matches()
{
	   ...
	   isset($competitionmeta['volgnummer']) && $competitionmeta['volgnummer'] != "" )
	{
		...
		$content .= "<a href=\"http://www.volleybal.nl/competitie/team/" . $competitionmeta['teamid'] . "\">Bekijk de wedstrijden op de site van de NeVoBo</a>";
	}
