...
class shotstyle_recent_posts extends WP_Widget
{
    ...
    function widget($args , $instance) {
    	extract($args);
        $title = isset($instance['title']) ? $instance['title'] : esc_html__('Recent Posts', 'shotstyle');
    ...
    function form($instance) {
      ...
      if(!isset($instance['title'])) $instance['title'] = esc_html__('Recent Posts', 'shotstyle');
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php esc_html_e('Limit Posts Number', 'shotstyle') ?></label>
