...
function ep_eventposts_save_meta( $post_id, $post ) {
	...
	$events_meta['event_timestamp'] = mktime($event_meta['event_hour'], $event_meta['event_minute'], 0, $event_meta['event_month'], $event_meta['event_day'], $event_meta['event_year'] );
...
function event_date_time() {
	...
	printf( '<span class="posted-on"><i class="fa fa-calendar"></i> %1$s</span><span class="byline"> <span class="posted-on"><i class="fa fa-clock-o"></i> %2$s</span><span class="byline"> <i class="fa fa-user"></i> %3$s</span>',
